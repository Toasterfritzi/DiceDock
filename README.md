...
Willkommen bei **DiceDock**! Mit dieser Anwendung kannst du deine Charaktere einfach erstellen, verwalten und überall hin mitnehmen. Schluss mit zerknitterten Papierbögen und verlorenen Notizen – alles, was du für dein nächstes Abenteuer brauchst, ist jetzt in einem atemberaubenden Design nur einen Klick entfernt.

---

## 🌌 Immersives Erlebnis

Tauche tief in deine Abenteuer ein mit unserer **einzigartigen Benutzeroberfläche**:
*   🌙 **Dark-Mode:** Augenschonend für lange Nächte am Spieltisch.
*   ✨ **Neon-Akzente:** Lass die Magie deines Charakters auch auf dem Bildschirm leuchten.
*   🪞 **Glassmorphism-Design:** Eine moderne, transparente und elegante Optik, die deine Heldentaten stilvoll in Szene setzt.
...
*   🗡️ **Grunddaten:** Name, Rasse, Klasse, Hintergrund und Gesinnung.
*   💪 **Attribute:** Behalte Stärke, Geschicklichkeit, Konstitution, Intelligenz, Weisheit und Charisma im Blick.
*   🛡️ **Kampfwerte:** Verwalte Lebenspunkte (HP), Rüstungsklasse (AC), Initiative und Geschwindigkeit direkt in deinem wunderschönen Dashboard.

### 🎒 **Inventar & Ausrüstung**
Nie wieder den Überblick über deine Beute verlieren!
*   💰 Verwalte dein **Gold** und deine **Ausrüstung**.
*   📜 Notiere wichtige Gegenstände und geheimnisvolle, magische Items.
